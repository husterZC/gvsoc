...
parser.add_argument("input_file", nargs="?", default="softhier/hw/softhier_arch.py", help="Path to the input Python file")
args = parser.parse_args()
input_file = args.input_file

# Read the input Python file
C_header_file = 'softhier/sw/runtime/include/softhier_arch.h'
S_header_file = 'softhier/sw/runtime/include/softhier_arch.inc'
