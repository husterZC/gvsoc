...
class Router(gvsoc.systree.Component):
    def __init__(self, parent, name, num_port, rx_depth):
        ...
        self.add_sources(['pulp/chips/velocity/unified_interconnect/router.cpp'])
    ...
    def o_TOP_OUT(self, itf: gvsoc.systree.SlaveItf):
        self.itf_bind(f'top_req_master', itf, signature='io')

    def i_TOP_INPUT(self) -> gvsoc.systree.SlaveItf:
        return gvsoc.systree.SlaveItf(self, f'top_req_slave', signature='io')
